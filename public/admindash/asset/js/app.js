...
class ThemeCustomizer {
    ...
    initSidenav() {
        ...
        document.querySelectorAll("ul.menu a.menu-link").forEach((n) => {
            if (n.href === e) {
                ...
                let t = n.parentElement.parentElement.parentElement.parentElement.parentElement;
            ...
            setTimeout(function () {
                ...
                null != t && ((e = document.querySelector(".app-menu .simplebar-content-wrapper")), (t = t.offsetTop - 300), e && 100 < t && ((o = 600), (a = (i = e).scrollTop), (c = t - a), (r = 0), d()));
            }, 200);
    }
    reverseQuery(e, t) {
        for (; e; ) {
                ...
                (e &&
                    e.addEventListener("click", function () {
                        ...
                        "mobile" === t
                            ...
                            : "condensed" === t
                            ? n.changeSidenavView("condensed" == e ? "default" : e, !1)
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__ADMINTO_CONFIG__", JSON.stringify(this.config)),
            document.querySelectorAll("#theme-customization input[type=checkbox]").forEach(function (e) {
                e.checked = !1;
            });
        var e,
            t,
            ...
            c = this.config;
        c &&
            ((e = document.querySelector("input[type=checkbox][name=dir][value=" + c.direction + "]")),
            (t = document.querySelector("input[type=checkbox][name=data-mode][value=" + c.theme + "]")),
            (n = document.querySelector("input[type=checkbox][name=data-layout-width][value=" + c.layout.width + "]")),
            (i = document.querySelector("input[type=checkbox][name=data-layout-position][value=" + c.layout.position + "]")),
            (o = document.querySelector("input[type=checkbox][name=data-topbar-color][value=" + c.topbar.color + "]")),
            (a = document.querySelector("input[type=checkbox][name=data-menu-color][value=" + c.menu.color + "]")),
            (c = document.querySelector("input[type=checkbox][name=data-sidenav-view][value=" + c.sidenav.view + "]")),
            e && (e.checked = !0),
            t && (t.checked = !0),
            n && (n.checked = !0),
            i && (i.checked = !0),
