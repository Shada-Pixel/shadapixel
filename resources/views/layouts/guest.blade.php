...
<head>
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-5J687FFFVM"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-5J687FFFVM');
    </script>
    <meta charset="utf-8">
    ...
    <script>
        ...
        fbq('init', '1155528752967060');
        fbq('track', 'PageView');
    </script>
    <noscript>
        <img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=1155528752967060&ev=PageView&noscript=1"/>
    </noscript>
    <!-- End Meta Pixel Code -->
